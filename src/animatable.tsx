...
const types = ['bounceOut', 'bounceOutDown', 'bounceOutUp', 'bounceOutLeft', 'bounceOutRight', 'fadeOut', 'fadeOutDown', 'fadeOutDownBig', 'fadeOutUp', 'fadeOutUpBig', 'fadeOutLeft', 'fadeOutLeftBig', 'fadeOutRight', 'fadeOutRightBig', 'lightSpeedOut', 'slideOutDown', 'slideOutUp', 'slideOutLeft', 'slideOutRight', 'zoomOut', 'zoomOutDown', 'zoomOutUp', 'zoomOutLeft', 'zoomOutRight']
